...
class BudgetEntity(id: EntityID<Int>) : IntEntity(id) {
    ...
    fun toResponse(authorFullName: String? = null, authorRecordCreatedAt: DateTime? = null): BudgetRecord {
        return BudgetRecord(year, month, amount, type, authorId, authorFullName, authorRecordCreatedAt?.toDate())
    }
}